...
const {getCart, removeProductFromCart,updateCart, getCartShipper, getCartDamua ,getCartHoanTra, getAllCarts, getAllCartsExceptPending, addToCart, updateCartStatus} = require('../controllers/cartController');
